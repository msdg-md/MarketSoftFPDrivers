...
*/
        ...
        {
            Log.Write("26666: GetCurrentTaxes:  Start", SoftMarket.Globals.Log.MessageType.Message, this);
            byte[] data = SendCommand(Command.GetCurrentTaxRates);
            Log.Write("26666: GetCurrentTaxes:  End", SoftMarket.Globals.Log.MessageType.Message, this);
            if(data.Length < 1)
                throw new FiscalPrinterException(DatecsStrings.GetString((int)Message.RecivedUninspected));
            ...
            Log.Write("26666: GetCurrentTaxes:  STR" + str, SoftMarket.Globals.Log.MessageType.Message, this);
            ...
            string str = string.Format("{0},{1},{2},{3},{4}", new object[]
	{
		...
		money4.ToString("S")
            ...
            Log.Write("26666999999999999: GetCurrentTaxes:  Start: " + str, SoftMarket.Globals.Log.MessageType.Message, this);
            return str;
        }
		...
		{
            Log.Write("PrintXReport Command.FiscalClosure = 0", SoftMarket.Globals.Log.MessageType.Message, this);
			SendCommand(Command.FiscalClosure, "0");
		}
        public virtual void PrintZReport(DateTime beginDate, DateTime endDate)
        {

            Log.Write("PrintZReport(DateTime beginDate, DateTime endDate) : " + beginDate.ToString("ddMMyy") + "; " + endDate.ToString("ddMMyy"), SoftMarket.Globals.Log.MessageType.Message, this);
		...
		{
            Log.Write("PrintZReport(int beginNum, int endNum) : " + beginNum + "; " + endNum.ToString("ddMMyy"), SoftMarket.Globals.Log.MessageType.Message, this);
        ...
        public virtual void RegisterItem(string artName, Money unitPrice, Quantity count, SoftMarket.Devices.Printers.TaxGrp taxGrp, bool printOneCount, int artNum, Money discount)
		{
            ...
            Log.Write("Pozitia dlea peceati: " + message, SoftMarket.Globals.Log.MessageType.Message, this);
        ...
        {
            Log.Write("CancelFiscalReceipt()", SoftMarket.Globals.Log.MessageType.Message, this);

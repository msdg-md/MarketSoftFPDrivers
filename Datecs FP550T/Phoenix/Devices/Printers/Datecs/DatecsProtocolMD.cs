...
namespace Phoenix.Devices.Printers.DatecsMD
{
    ...
    public class DatecsProtocol
    {
        ...
        public void Connect(Port port, uint baudrate)
        {
        ...
        private byte[] PrepareReceivedPacket(byte[] receivedPacket)
        {
            ...
            Log.Write($"Response status: ({status.ToString()})", Log.MessageType.Message, this);
            ...
            string str = string.Format("{0},{1},{2},{3},{4}", new object[]
    {
        ...
        public virtual void RegisterItem(string artName, Money unitPrice, Quantity count, Printers.TaxGrp taxGrp, bool printOneCount, int artNum, Money discount)
        {

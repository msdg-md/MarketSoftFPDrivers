...
namespace Phoenix.Devices.Printers.Elicom
{
    public class TremolS : Elicom
    {
        ...
        public override Parameter[] Parameters
        {
            get
            {
                List<Parameter> parameters = new List<Parameter>(base.Parameters);

                parameters.Add(new Parameter((int)SettingsParameter.IsStandartPrinting, tremolSPrinter.IsStandartPrinting ? CultureStrings.StandartPrinting : CultureStrings.PrintingAfterClose, new string[] { CultureStrings.StandartPrinting, CultureStrings.PrintingAfterClose }, CultureStrings.PrintingType));
